...
async function waitEndGame() {
  ...
  try {
    ...
    // await page.waitFor('#instructions > span:nth-child(1)', {timeout: 30000});
    const result = await page.waitFor(() => document.querySelector('#instructions > span:nth-child(1)').textContent, {timeout: 30000});
    console.log(result);
    console.log('done');
    return result;
  } finally {
